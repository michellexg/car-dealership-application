...
from .views import list_sales, list_sales_history, create_sales_person, create_customer, create_salerecord
...
urlpatterns = [
    ...
    path("sales/salerecord/", create_salerecord, name="create_salerecord")
]
